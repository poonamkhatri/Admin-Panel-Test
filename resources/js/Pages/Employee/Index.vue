		...
		<div class="py-12">
			...
			<div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
				<div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
					...
					<a href="#" @click="deleteSelectedemployees"
	...
	methods: {
		...
		deletecompany: function (company) {
			this.confirmAction('Are you sure you want to delete company?', function () {
				this.$inertia.delete(route('employees.destroy', company.id));
			}.bind(this));
		},
		search() {
			this.$inertia.replace(this.route('employees.index', { term: this.term }))
		},
		async deleteSelectedemployees() {
			...
			const confirmed = confirm(`Are you sure you want to delete ${this.selectedemployees.length} company(s)?`);
			if (!confirmed) {
				return;
			}

			try {
				await this.$inertia.post('/employees/delete', { ids: this.selectedemployees });
